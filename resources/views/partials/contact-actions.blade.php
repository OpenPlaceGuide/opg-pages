{{-- Call/Website buttons for a POI. Callers pass the pre-computed $phones
     (array) and $website (string|null) and wrap these in their own flex row. --}}
@php($phones ??= [])
...
@endforeach
@if(!empty($website))
    <a href="{{ $website }}" target="_blank" rel="noopener" class="btn-quiet">
